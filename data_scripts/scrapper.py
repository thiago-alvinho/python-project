...
DIR_SAIDA = os.path.join(BASE_DIR, "downloads_ans/csv")
...
def listar_links(url, padrao_regex):
    ...
    return sorted(links_encontrados, reverse=True) #Inverter a ordem para pegar dos anos mais recentes para os mais antigos
